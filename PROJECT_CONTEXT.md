...
> **Sync:** A duplicate used for GitHub sync from the Control Center repo lives at **`fendi-control-center/docs/fairway-fixer-18/PROJECT_CONTEXT.md`**. Keep these files in lockstep; see `fendi-control-center/docs/CLAUDE_HANDOFF_PROMPT.md`.
